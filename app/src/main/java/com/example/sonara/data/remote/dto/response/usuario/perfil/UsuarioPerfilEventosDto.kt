...
data class UsuarioPerfilEventosDto(
    ...
    @SerializedName("status")            val status: UsuarioPerfilEventoStatusDto?,  // <- era String?
    @SerializedName("fotos")             val fotos: List<UsuarioPerfilEventoFotosDto?>? = null,
    ...
    @SerializedName("id_evento_artista") val idEventoArtista: Int? = null
)